...
<div>
	...
	<h2 style="color:white" align="center">Welcome Admin! Here you can Insert and Delete data in this catalog. </h2>
	<form method="post" action="insert.html">
    <button style="text-align:center;font-size: 15px" ><b><center>Insert</center></button>
    </form>


	<form method="post" action="delete.html">
	<button style="text-align:center;font-size: 15px" ><b><center>Delete</center></button>
	</form>
		<!--</div>
		<div class="logout">
